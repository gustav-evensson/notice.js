...
1. Copy the [notice](https://github.com/gustav-evensson/notice.js/tree/main/notice) <a href="image_location.zip" download>gzip</a> folder containing the notice.js and notice.css files.

class Notice {
	constructor({ position, theme, animation }) {
		(this.position = position || 'bottom-left'), (this.theme = theme || 'light'), (this.animation = animation || 'slide-right');
	...
	createNotice(text, type, duration) {
		...
		const icons = {
            ...
            <path d="M17 24.4375C17.8802 24.4375 18.5938 23.724 18.5938 22.8438C18.5938 21.9635 17.8802 21.25 17 21.25C16.1198 21.25 15.4062 21.9635 15.4062 22.8438C15.4062 23.724 16.1198 24.4375 17 24.4375Z" fill="#D64747"/>
            </svg>
            `,
            ...
            <path d="M17 25.5C17.8802 25.5 18.5938 24.7865 18.5938 23.9062C18.5938 23.026 17.8802 22.3125 17 22.3125C16.1198 22.3125 15.4062 23.026 15.4062 23.9062C15.4062 24.7865 16.1198 25.5 17 25.5Z" fill="#D27722"/>
            </svg>
            `,
            ...
            <path d="M16.7344 12.75C17.6146 12.75 18.3281 12.0365 18.3281 11.1562C18.3281 10.276 17.6146 9.5625 16.7344 9.5625C15.8542 9.5625 15.1406 10.276 15.1406 11.1562C15.1406 12.0365 15.8542 12.75 16.7344 12.75Z" fill="#5274CA"/>
            </svg>
            `,

...
#notice-container.dark .notification-close svg path {
  stroke: #ffffff;
}

#notice-container.rounded .notification {
  border-radius: 50px;
}
...
#notice-container.bottom-right .notification.show,
#notice-container.bottom-center .notification.show,
#notice-container.bottom-left .notification.show {
  opacity: 1;
  translate: 0 0;
}
</style>
